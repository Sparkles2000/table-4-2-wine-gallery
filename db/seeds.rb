...
b1 = Brandofwine.create!(brand: 'Barefoot', age: 2021, winetype: 'Pinot Grigio', price: '$5.99', drysweet: 'Semi-Sweet', alcoholcontent: '12.5%', img_src: 'https://wp.me/a9JdbU-n')
b2 = Brandofwine.create!(brand: 'Barefoot', age: 2021, winetype: 'White Zinfindel', price: '$5.99', drysweet: 'Sweet', alcoholcontent: '9%', img_src: 'https://wp.me/a9JdbU-n')
b3 = Brandofwine.create!(brand: 'Barefoot', age: 2021, winetype: 'California Cabernet Sauvignon', price: '$5.99', drysweet: 'Dry', alcoholcontent: '13.5%', img_src: 'https://wp.me/a9JdbU-n')
b4 = Brandofwine.create!(brand: 'Barefoot', age: 2021, winetype: 'Moscato', price: '$5.99', drysweet: 'Sweet', alcoholcontent: '9%', img_src: 'https://wp.me/a9JdbU-n')
b5 = Brandofwine.create!(brand: 'Barefoot', age: 2021, winetype: 'Pink Moscato', price: '$5.99', drysweet: 'Sweet', alcoholcontent: '9%', img_src: 'https://wp.me/a9JdbU-n')
b6 = Brandofwine.create!(brand: 'Barefoot', age: 2021, winetype: 'Merlot', price: '$5.99', drysweet: 'Dry', alcoholcontent: '13%', img_src: 'https://wp.me/a9JdbU-n')
b7 = Brandofwine.create!(brand: 'Black Girl Magic', age: 2019, winetype: 'Red Blend', price: '$19.97', drysweet: 'Sweet', alcoholcontent: '13.5%', img_src: 'https://wp.me/a9JdbU-o')
b8 = Brandofwine.create!(brand: 'Black Girl Magic', age: 2018, winetype: 'Merlot', price: '$17.99', drysweet: 'Dry', alcoholcontent: '13.5%', img_src: 'https://wp.me/a9JdbU-o')
b9 = Brandofwine.create!(brand: 'Black Girl Magic', age: 2018, winetype: 'Zinfandel', price: '$24.99', drysweet: 'Dry', alcoholcontent: '13.5%', img_src: 'https://wp.me/a9JdbU-o')
b10 = Brandofwine.create!(brand: 'Black Girl Magic', age: 2020, winetype: 'Riesling', price: '$19.99', drysweet: 'Semi-Sweet', alcoholcontent: '13.5%', img_src: 'https://wp.me/a9JdbU-o')
b11 = Brandofwine.create!(brand: 'Black Girl Magic', age: 2021, winetype: 'Sparkling Brut', price: '$28.49', drysweet: 'Dry', alcoholcontent: '13%', img_src: 'https://wp.me/a9JdbU-o')
b12 = Brandofwine.create!(brand: 'Black Girl Magic', age: 2020, winetype: 'Moscato Rose', price: '$16.19', drysweet: 'Sweet', alcoholcontent: '13.5%', img_src: 'https://wp.me/a9JdbU-o')
b13 = Brandofwine.create!(brand: 'Bottega Gold', age: 2021, winetype: 'Brut', price: '$35', drysweet: 'Dry', alcoholcontent: '11%', img_src: 'https://wp.me/a9JdbU-p')
b14 = Brandofwine.create!(brand: 'Bottega Rose Gold', age: 2021, winetype: 'Pinot Nior', price: '$35', drysweet: 'Sweet', alcoholcontent: '11.5%', img_src: 'https://wp.me/a9JdbU-p')
b15 = Brandofwine.create!(brand: 'Bottega White Gold', age: 2021, winetype: 'Pinot Nior', price: '$35', drysweet: 'Dry', alcoholcontent: '12%', img_src: 'https://wp.me/a9JdbU-p')
b16 = Brandofwine.create!(brand: 'Krug', age: 2021, winetype: 'Brut', price: '$179.99', drysweet: 'Dry', alcoholcontent: '12%', img_src: 'https://wp.me/a9JdbU-q')
b17 = Brandofwine.create!(brand: 'One Hope', age: 2021, winetype: 'Brut', price: '$39', drysweet: 'Dry', alcoholcontent: '11.5%', img_src: 'https://wp.me/a9JdbU-r')
b18 = Brandofwine.create!(brand: 'One Hope', age: 2019, winetype: 'Pinot Nior', price: '$35', drysweet: 'Dry', alcoholcontent: '12.5%', img_src: 'https://wp.me/a9JdbU-u')
b19 = Brandofwine.create!(brand: "Risata Moscato D'Asti", age: 2020, winetype: 'Moscato', price: '$12.99', drysweet: 'Sweet', alcoholcontent: '5.5%', img_src: 'https://wp.me/a9JdbU-t')
b20 = Brandofwine.create!(brand: 'Stella Rose', age: 2021, winetype: 'Red Blend', price: '$12.99', drysweet: 'Sweet', alcoholcontent: '5%', img_src: 'https://wp.me/a9JdbU-u')
b21 = Brandofwine.create!(brand: 'Sun Goddess', age: 2019, winetype: 'Pinot Grigio', price: '$19.99', drysweet: 'dry', alcoholcontent: '12.5%', img_src: 'https://wp.me/a9JdbU-v')
b22 = Brandofwine.create!(brand: 'Sun Goddess', age: 2019, winetype: 'Sauvignon Blanc', price: '$19.99', drysweet: 'Dry', alcoholcontent: '12.5%', img_src: 'https://wp.me/a9JdbU-v')
b23 = Brandofwine.create!(brand: 'Usual', age: 2019, winetype: 'Red Blend', price: '$8', drysweet: 'Sweet', alcoholcontent: '14%', img_src: 'https://wp.me/a9JdbU-w')
b24 = Brandofwine.create!(brand: 'Usual', age: 2021, winetype: 'Brut', price: '$8', drysweet: 'Dry', alcoholcontent: '12%', img_src: 'https://wp.me/a9JdbU-w')
b25 = Brandofwine.create!(brand: 'Usual', age: 2020, winetype: 'Moscato Rose', price: '$8', drysweet: 'Semi-Sweet', alcoholcontent: '13.5%', img_src: 'https://wp.me/a9JdbU-w')
...
p1 = Artpiece.create!(artists: 'Jake and Anita Henderson', piece: 'Trapped in art', artstyle: 'Graffiti Art', img_src: 'https://wp.me/a9JdbU-11', artsession_id: a1.id)
p2 = Artpiece.create!(artists: 'Susan Parker', piece: 'Abstract', artstyle: 'Block', img_src: 'https://wp.me/a9JdbU-10', artsession_id: a2.id)
p3 = Artpiece.create!(artists: 'Allen Parker', piece: 'Pinkish', artstyle: 'Block', img_src: 'https://wp.me/a9JdbU-Z', artsession_id: a2.id)
p4 = Artpiece.create!(artists: 'Heather McMillen', piece: 'Graffiti', artstyle: 'Block', img_src: 'https://wp.me/a9JdbU-11', artsession_id: a2.id)
p5 = Artpiece.create!(artists: 'James McMillen', piece: 'Stained Window', artstyle: 'Block', img_src: 'https://wp.me/a9JdbU-12', artsession_id: a2.id)
p6 = Artpiece.create!(artists: 'Jessica Peterson', piece: 'Distress', artstyle: 'Charcoal', img_src: 'https://wp.me/a9JdbU-Y', artsession_id: a3.id)
p7 = Artpiece.create!(artists: 'Jack Levins', piece: 'Ink Block Magic', artstyle: 'Ink Block', img_src: 'https://wp.me/a9JdbU-T', artsession_id: a3.id)
p8 = Artpiece.create!(artists: 'Susan Hopewell', piece: 'Yellow', artstyle: 'Block', img_src: 'https://wp.me/a9JdbU-13', artsession_id: a3.id)
p9 = Artpiece.create!(artists: 'Jake Henderson', piece: 'Flower Child', artstyle: 'Charcoal', img_src: 'https://wp.me/a9JdbU-J', artsession_id: a4.id)
p10 = Artpiece.create!(artists: 'Anita Henderson', piece: 'Part Of The Painting', artstyle: 'Color Splashing', img_src: 'https://wp.me/a9JdbU-S', artsession_id: a4.id)
p11 = Artpiece.create!(artists: 'Denzel Arlington', piece: 'Sunset Over The Mountains', artstyle: 'Sketch', img_src: 'https://wp.me/a9JdbU-B', artsession_id: a5.id)
p12 = Artpiece.create!(artists: 'Janice Thomson', piece: 'Lonely Dancer', artstyle: 'Sketch', img_src: 'https://wp.me/a9JdbU-A', artsession_id: a6.id)
p13 = Artpiece.create!(artists: 'Dan Jacobs', piece: 'Blue Ice', artstyle: 'Block', img_src: 'https://wp.me/a9JdbU-19', artsession_id: a6.id)
p14 = Artpiece.create!(artists: 'Harold Wensington and Ashley Wensington', piece: 'Mommy', artstyle: 'Sketch', img_src: 'https://wp.me/a9JdbU-Y', artsession_id: a7.id)
p15 = Artpiece.create!(artists: 'Dan Jacobs and Janice Thomson', piece: 'Vintage Luxury', artstyle: 'Pastel', img_src: 'https://wp.me/a9JdbU-I', artsession_id: a8.id)
p16 = Artpiece.create!(artists: 'Patricia Ellison', piece: 'Mountain Peak', artstyle: 'Oil Painting', img_src: 'https://wp.me/a9JdbU-W', artsession_id: a9.id)
p17 = Artpiece.create!(artists: 'Daniel Ellison', piece: 'Street Art', artstyle: 'Graffiti Art', img_src: 'https://wp.me/a9JdbU-1a', artsession_id: a9.id)
p18 = Artpiece.create!(artists: 'Alyssa Ellington', piece: 'Isabella Clara Eugienia', artstyle: 'Oil Painting', img_src: 'https://wp.me/a9JdbU-M', artsession_id: a9.id)
p19 = Artpiece.create!(artists: 'Robert Ellington', piece: 'Breakfast', artstyle: 'Oil Painting', img_src: 'https://wp.me/a9JdbU-K', artsession_id: a9.id)
p20 = Artpiece.create!(artists: 'Jennifer Ellington', piece: 'Peaceful Mountain Sky', artstyle: 'Water Coloring', img_src: 'https://wp.me/a9JdbU-X', artsession_id: a9.id)
p21 = Artpiece.create!(artists: 'Susan and Allen Parker', piece: 'Wooded Landscape', artstyle: 'Painting', img_src: 'https://wp.me/a9JdbU-Q', artsession_id: a10.id)
p22 = Artpiece.create!(artists: 'Heather and James McMillen', piece: 'Paint Me All Over', artstyle: 'Painting', img_src: 'https://wp.me/a9JdbU-U', artsession_id: a10.id)
